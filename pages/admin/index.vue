<template>
  <main class="admin-page">
    ...
    <section class="metric-grid">
      ...
      <article class="metric surface">
        <span>결제 대기</span
        ><strong>{{ dashboard.pendingPaymentCount }}</strong>
      </article>
      <article class="metric surface">
        <span>배송 준비</span
        ><strong>{{ dashboard.preparingDeliveryCount }}</strong>
      </article>
      <article class="metric surface">
        <span>품절 임박</span
      ...
      <article class="metric surface">
        <span>신규 회원</span><strong>{{ dashboard.newUserCount }}</strong>
      </article>
      <article class="metric surface">
        <span>성인 인증 회원</span
        ><strong>{{ dashboard.adultVerifiedCount }}</strong>
      </article>
    </section>
