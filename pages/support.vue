  ...
  <main class="section page-shell">
    ...
    <div class="two-column">
      <section class="surface form-panel">
        <h2>문의 작성</h2>
        <form class="form-grid" @submit.prevent="submitted = true">
          <div class="form-row">
          ...
          <p v-if="submitted" class="success">문의가 접수되었습니다. 실제 운영에서는 Firestore inquiries 컬렉션에 저장됩니다.</p>
        </form>
      </section>
      <section class="surface form-panel">
        <h2>운영 안내</h2>
        <p>회원, 주문, 배송, 픽업 정책은 공지사항과 이용안내에서 함께 확인할 수 있습니다.</p>
