<template>
  <aside class="admin-sidebar">
    <NuxtLink class="admin-logo" to="/admin">{{ brand.name }} Admin</NuxtLink>
    <nav>
...
const items = [
  ...
  { to: "/admin/orders", label: "주문 관리", icon: ShoppingCart },
  ...
  { to: "/admin/inquiries", label: "문의 관리", icon: MessageSquareText },
  { to: "/admin/messages", label: "메시지 테스트", icon: Send },
  { to: "/admin/reviews", label: "리뷰 관리", icon: Star },
