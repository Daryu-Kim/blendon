...
const products = [
  {
    ...
    description: '간결한 조작감과 안정적인 휴대성을 기준으로 구성한 입문형 디바이스입니다.',
    ...
    stock: 18,
    options: [{ optionId: 'black', optionName: 'Charcoal Black', optionCode: 'BDO-BK', additionalPrice: 0, stock: 10, isActive: true }],
    badges: ['입문 추천', '회원가'],
    tags: ['컴팩트', '데일리'],
    flavorProfile: { sweetness: 0, coolness: 0, body: 3, mood: ['daily'], notes: ['device'] },
    deviceType: 'starter',
