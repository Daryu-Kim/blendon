...
export const mockProducts: Product[] = [
  {
    ...
    description:
      "간결한 조작감과 안정적인 휴대성을 기준으로 구성한 입문형 디바이스입니다. 호환 리필과 함께 선택할 수 있습니다.",
    categoryIds: ["device", "device-starter", "starter-pick"],
    brandName: "Blend Studio",
    thumbnailUrl: productImage("Device One"),
    imageUrls: [
      productImage("Device One"),
      productImage("Starter Kit", "F7F3EA", "8FAE9D"),
    ],
    basePrice: 52000,
    memberPrice: 49000,
  ...
  },
  {
    ...
    description:
      "과일 향과 산뜻한 마무리를 중심으로 만든 니코틴 프리 플레이버입니다. 성분 안내와 사용 방법을 확인한 뒤 선택해 주세요.",
    categoryIds: [
      "flavor",
      "flavor-fruit",
      "nicotine-free",
  ...
  },
  {
    ...
    description:
      "멘솔 노트를 중심으로 산뜻하게 정리한 니코틴 프리 제품입니다. 개인 취향과 디바이스 호환성을 먼저 확인해 주세요.",
    categoryIds: [
      "flavor",
      "flavor-menthol",
      "nicotine-free",
  ...
  },
  {
    ...
    description:
      "휴대와 교체가 쉬운 카트리지입니다. 호환 모델과 권장 교체 주기를 확인해 주세요.",
  ...
  },
  {
    ...
    description:
      "입문에 필요한 기본 구성을 한 번에 확인할 수 있는 키트입니다. 구성품과 호환 범위를 확인한 뒤 선택해 주세요.",
  ...
  },
  {
    ...
    description:
      "성인 인증 완료 회원만 상세 안내를 확인할 수 있는 상품입니다. 성분과 사용 안내를 충분히 확인한 뒤 선택해 주세요.",
...
export const mockNotices: Notice[] = [
  {
    ...
    content:
      "성인 전용 상품은 로그인과 성인 인증 완료 후에만 상세 정보와 가격을 확인할 수 있습니다.",
    isPinned: true,
    createdAt: now,
    updatedAt: now,
  },
  {
    ...
    content:
      "온라인 주문 후 매장 픽업 기능은 오프라인 매장 오픈 일정에 맞춰 순차적으로 제공될 예정입니다.",
    isPinned: false,
    createdAt: now,
    updatedAt: now,
  },
